...
Status: **multiframe transport, true mid-run resource replacement, controlled process/device-loss handling and bounded depth-1/depth-2 backpressure implemented and host-tested with first timing/copy accounting and negative-path diagnostics; broader failure timing and stereo expansion pending**.
