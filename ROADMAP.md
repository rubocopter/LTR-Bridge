...
Status: **implemented, host-tested and visual-validated for static/camera/rigid-object/disocclusion ground truth, explicit history validity and the controlled camera+depth baseline; performance and expanded-content validation pending**.
