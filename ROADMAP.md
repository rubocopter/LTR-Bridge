...
Status: **implemented, host-tested and visual-validated for static/camera/rigid-object/deforming-geometry/masked-particle/blended-transparency/disocclusion controlled cases, explicit history validity and the controlled camera+depth baseline; performance and expanded-content validation pending**.
