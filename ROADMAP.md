...
Status: **multiframe transport, true mid-run resource replacement and controlled process/device-loss handling implemented and host-tested with first timing/copy accounting and negative-path diagnostics; backpressure, broader failure timing and stereo expansion pending**.
