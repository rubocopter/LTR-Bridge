...
21. **Experiment-pending:** real skinned/cloth content, particles/transparency, HUD/highlights, real-content optical-flow validation, native-AA backend mapping, frame-time/VRAM measurement, SR, and stereo.
...
5. Continue controlled content coverage after the new procedural deforming-geometry proxy: add small deterministic particles/transparency and HUD/highlight cases, and keep real skinned/cloth content explicitly pending before treating any provider as broadly representative. The dedicated disocclusion/history-validity case is implemented.
