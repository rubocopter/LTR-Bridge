...
The documentation has been reconciled to the current probe state: completed transport/D3D9Ex/D3D10/XeSS/OpenXR-bootstrap work is no longer listed as merely planned, while real-game interception, D3D10 temporal-data integration, broader backend comparison, OpenXR presentation and headset validation remain explicit pending work.
