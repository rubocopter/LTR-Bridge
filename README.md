...
As of 2026-09-16 the repository contains the controlled D3D11 x64 research harness, independent optical-flow baseline, a host-tested XeSS Native AA probe, a host-tested multiframe D3D11 x86 -> D3D12 x64 transport probe, current-host D3D9Ex and D3D10.1 -> D3D11 -> modern-host relays, and an isolated host-tested OpenXR runtime/bootstrap probe. No production injector, real-game integration, OpenXR presentation path, physical-headset validation, or performance-validated support claim is implemented.
